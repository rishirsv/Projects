...
const HeroSectionComponent = ({
  ...
  const { registry } = useActiveModel();
  const hasModelOptions = registry.options.length > 0;
  ...
  return (
    <section className="hero-card">
      <div className="hero-overline">
        ...
        {hasModelOptions && <ModelSelector variant="subtle" />}
      </div>
      <h1 className="hero-title">
        Learn faster with <span>multi-model AI</span> recaps.
      </h1>
